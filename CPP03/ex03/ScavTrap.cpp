...
/*   Updated: 2022/08/02 18:13:24 by asimon           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ScavTrap::ScavTrap(ScavTrap const &old): ClapTrap(old.getName())
{
	std::cout << "ScavTrap " << this->getName() << " | Copy Constructor" << std::endl;
	this->_guardGate = old._guardGate;
