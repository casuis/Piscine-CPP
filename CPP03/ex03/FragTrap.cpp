...
/*   Updated: 2022/08/02 18:11:52 by asimon           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	FragTrap::highFivesGuys(void)
{
	...
	else if (prompt.compare("n") == 0 || prompt.compare("N") == 0)
		std::cout << this->getName() << " look sad, weird little guy..." << std::endl;
	else
	{
		std::cout << "We can't understant, as " << this->getName() << " does... try laterz" << std::endl;
	}
	return ;
}

size_t		FragTrap::getAttackDmg() const
{
	return (30);
}